...
# __init__(self, text) The getter method get_message_text(self) The getter
# method get_valid_words(self), notice that this one returns a copy of
# self.valid_words to prevent someone from mutating the original list. In this
# problem, you will fill in two methods:
...
# >>> print(string.ascii_uppercase) ABCDEFGHIJKLMNOPQRSTUVWXYZ A reminder from
# >>> the introduction page - characters such as the space character, commas,
# >>> periods, exclamation points, etc will not be encrypted by this cipher -
